...
export const metadata: Metadata = {
  title: "About Us | CinemaHub",
  description: "Learn about CinemaHub and our mission to provide the ultimate cinema experience",
}

export default function AboutPage() {
  return (
    <main className="flex justify-center min-h-screen bg-gradient-to-b from-zinc-50 to-white dark:from-zinc-900 dark:to-black">
      <div className="w-full max-w-4xl px-4 py-12 md:py-16 lg:py-20">
        {/* Hero Section */}
        <div className="mb-12 text-center">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-5xl">
            About <span className="text-red-600">CinemaHub</span>
          </h1>
        ...
        <div className="space-y-12">
            {/* Our Story */}
            <section className="rounded-xl bg-white p-6 shadow-lg dark:bg-zinc-800">
            <div className="flex items-center gap-4 mb-6">
              ...
              <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">
                Founded in 2024, CinemaHub began with a simple mission: to create an extraordinary cinema experience that
            ...
            <section className="rounded-xl bg-white p-6 shadow-lg dark:bg-zinc-800">
             <div className="flex items-center gap-4 mb-6">
              ...
              <p className="text-zinc-600 dark:text-zinc-300 leading-relaxed">
                At CinemaHub, we believe that movies are meant to be experienced, not just watched. Our mission is to
            ...
            {/* The CinemaHub Experience */}
            <section className="rounded-xl bg-white p-6 shadow-lg dark:bg-zinc-800">
            <div className="flex items-center gap-4 mb-6">
                <div className="h-12 w-2 bg-red-600 rounded-full"></div>
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">The CinemaHub Experience</h2>
              </div>
              
              <div className="grid gap-8 md:grid-cols-2">
                <div className="flex flex-col gap-4 p-4 rounded-lg bg-zinc-50 dark:bg-zinc-700">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">Premium Comfort</h3>
                  </div>
                ...
                <div className="flex flex-col gap-4 p-4 rounded-lg bg-zinc-50 dark:bg-zinc-700">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">Cutting-Edge Technology</h3>
                  </div>
                  <p className="text-zinc-600 dark:text-zinc-300">
                ...
                <div className="flex flex-col gap-4 p-4 rounded-lg bg-zinc-50 dark:bg-zinc-700">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">Gourmet Concessions</h3>
                  </div>
                  <p className="text-zinc-600 dark:text-zinc-300">
                ...
                <div className="flex flex-col gap-4 p-4 rounded-lg bg-zinc-50 dark:bg-zinc-700">
                  <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-xl font-semibold text-zinc-900 dark:text-white">Community Focus</h3>
                  </div>
                  <p className="text-zinc-600 dark:text-zinc-300">
            ...
            <section className="rounded-xl bg-white p-6 shadow-lg dark:bg-zinc-800">
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {[
                  ...
                  <div key={value.name} className="p-4 rounded-lg bg-zinc-50 dark:bg-zinc-700">
                    <h3 className="text-lg font-semibold text-red-600 dark:text-red-400">{value.name}</h3>
                    <p className="mt-1 text-zinc-600 dark:text-zinc-300">{value.desc}</p>
                  </div>
                ))}
              </div>
            </section>
            ...
            <section className="rounded-xl bg-white p-6 shadow-lg dark:bg-zinc-800">
              <div className="flex items-center gap-4 mb-6">
                <div className="h-12 w-2 bg-red-600 rounded-full"></div>
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Leadership Team</h2>
              </div>
              
              <div className="grid gap-6 sm:grid-cols-2">
                {[
                  { name: "Sarah A.Abu Zeneh", role: "Chief Executive Officer" },
                  { name: "Yakoob Hammouri", role: "Chief Operations Officer" },
                  { name: "Khaldoun Khaled", role: "Chief Technology Officer" },
                    ].map((member) => (
