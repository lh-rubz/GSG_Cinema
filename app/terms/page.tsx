...
export const metadata: Metadata = {
  title: "Terms & Conditions | CinemaHub",
  description: "Terms and conditions for using CinemaHub services",
}

export default function TermsPage() {
  return (
    <main className="py-20! md:py-20 lg:py-20 bg-white dark:bg-zinc-900 text-zinc-900 dark:text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-center text-red-600 dark:text-red-500 tracking-tight mb-6">
          Terms and Conditions
        </h1>
        <p className="text-center text-zinc-600 dark:text-zinc-300 mb-8">Last updated: March 23, 2024</p>

        <div className="space-y-8">
          {/* Section 1 */}
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            <h2 className="text-2xl font-semibold text-red-600 dark:text-red-500 mb-4">1. Introduction</h2>
            <p className="text-zinc-700 dark:text-zinc-300">
              Welcome to CinemaHub! These Terms and Conditions govern your use of our website, mobile applications, and
              services. By accessing or using CinemaHub, you agree to be bound by these Terms. If you disagree with any part
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <ul className="list-disc pl-6 space-y-2 text-zinc-700 dark:text-zinc-300">
              <li><strong>"CinemaHub"</strong> refers to our company, our website, mobile applications, and services.</li>
              <li><strong>"Services"</strong> refers to movie screenings, concessions, and any other products or services offered by CinemaHub.</li>
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
              ...
              <ul className="list-disc pl-8 space-y-1 text-zinc-700 dark:text-zinc-300">
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
              ...
              <p>
                4.3 <strong>Rescheduling:</strong> In the event of a canceled screening, CinemaHub will offer either a refund or the option to reschedule for another showtime.
              </p>
            </div>
          </section>
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
              <p>
                5.1 <strong>Ownership:</strong> All content on our platforms, including logos, designs, text, graphics, and software, is the property of CinemaHub or its licensors and is protected by copyright and other intellectual property laws.
              </p>
              <p>
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <div className="space-y-4 text-zinc-700 dark:text-zinc-300">
              <p>
                7.1 <strong>Disclaimer:</strong> CinemaHub provides its services "as is" and "as available" without warranties of any kind, either express or implied.
              </p>
              <p>
                7.2 <strong>Limitation:</strong> To the maximum extent permitted by law, CinemaHub shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from your use of our services.
              </p>
            </div>
          </section>
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              You agree to indemnify and hold harmless CinemaHub and its affiliates, officers, employees, and agents from any claims, liabilities, damages, losses, and expenses arising from your use of our services or violation of these Terms.
            </p>
          </section>
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              CinemaHub reserves the right to modify these Terms at any time. We will provide notice of significant changes. Your continued use of our services after such modifications constitutes your acceptance of the updated Terms.
            </p>
          </section>
          ...
          <section className="bg-zinc-100 dark:bg-zinc-700 p-6">
            ...
            <p className="text-zinc-700 dark:text-zinc-300">
              These Terms shall be governed by and construed in accordance with the laws of the jurisdiction in which CinemaHub is registered, without regard to its conflict of law provisions.
            </p>
          </section>
