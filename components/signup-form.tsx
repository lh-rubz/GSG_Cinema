    ...
    return (
        <div className="flex justify-center items-center min-h-screen">
            <div className="bg-zinc-900 p-8 rounded-lg shadow-lg w-96">
                ...
                <p className="text-gray-400 mb-6">Sign up to access exclusive features and book tickets</p>
                ...
                <p className="text-gray-400 text-center mt-4">
                    Already have an account? <a href="/signin" className="text-red-600">Sign in</a>
                </p>
            </div>
        </div>
    );
