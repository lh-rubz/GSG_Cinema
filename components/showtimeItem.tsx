...
const ShowtimeItem = ({ showTimes, movie }: Iprops) => {
  return (
    <div className="bg-white shadow-lg rounded-lg w-full mx-auto flex flex-col items-start border border-gray-300 md:flex-row overflow-hidden">
      <img
        src={movie.image || ""}
        ...
        <div className="mt-4">
          ...
          <div className="mt-2 flex gap-2 flex-wrap">
            {showTimes.map((show, index) => (
              ...
              >
                {show.time}
                <span className="text-xs text-gray-500">Theater 1</span>
              </Link>
            ))}
          </div>
        </div>
